...
class AdminAccountServiceTest {
    ...
    @DisplayName("존재하는 회원 ID를 검색하면, 회원 데이터를 Optional로 변환한다.")
    @Test
    ...
    void givenUserParams_whenSaving_thenSavesAdminAccount() {
        // Given
        AdminAccount adminAccount = createSigningUpAdminAccount("hyeon", Set.of(RoleType.USER));
    ...
    @Test
    void givenNothing_whenSelectionAdminAccounts_thenReturnsAllAdminAccounts() {
        // Given
    ...
    private AdminAccount createAdminAccount(String userId) {
        return createAdminAccount(userId, Set.of(RoleType.USER), null);
    }

    private AdminAccount createSigningUpAdminAccount(String userId, Set<RoleType> roleTypes) {
        return createAdminAccount(userId, roleTypes, userId);
    }

    private AdminAccount createAdminAccount(String userId, Set<RoleType> roleTypes, String createdBy) {

...
import com.studyproject.boardadminproject.dto.response.ArticleClientResponse;
...
class ArticleManagementServiceTest {
    ...
    class RealApiTest {
        ...
        @Autowired
        RealApiTest(ArticleManagementService sut) {
            this.sut = sut;
        }
    ...
    class RestTemplateTest {
        ...
        @DisplayName("게시글 ID로 게시글 API를 호출하면, 게시글을 가져온다.")
        @Test

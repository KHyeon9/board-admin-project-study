...
import com.studyproject.boardadminproject.dto.response.UserAccountClientResponse;
...
class UserAccountManagementServiceTest {
    ...
    class RealApiTest {
        ...
        void givenNothing_whenCallingUserAccountApi_thenReturnsUserAccountList() {
            ...
            // Assert
            System.out.println(result.stream().findFirst()); // API 호출 결과를 관찰
    ...
    class RestTemplateTest {
        ...
        void givenNothing_whenCallingUserAccountsApi_thenReturnsUserAccountList() throws Exception {
            // Given
            UserAccountDto expectedUserAccount = createUserAccountDto("hyeon", "Hyeon");
        ...
        void givenUserAccountId_whenCallingUserAccountApi_thenReturnsUserAccount() throws Exception {
            // Given
            String userId = "hyeon";
            UserAccountDto expectedUserAccount = createUserAccountDto(userId, "Hyeon");
